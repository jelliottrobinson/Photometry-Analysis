...
# for no stim use TRANGE and BASELINE_PER [0, 300] for 5 minute run
TRANGE = [-10, 21] # [-10, 230] for 10 s IPI; [-10, 33] for 0.1s IPI; [-10, 21] default
BASELINE_PER = [-10, -1]
DOWNSAMPLE_RATE = 10
...
ISOS = '_405A'
EPOC = 'PC0_'
# add epocs channel -- using an index (epocs[1]) in my_tdt_obj will not work
# consistently
